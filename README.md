...
Описание архитектуры и UML-диаграммы находятся в:
- `docs/architecture.md`
- `docs/uml/component.puml`
- `docs/uml/sequence-auth.puml`
...
Каркас презентации и графические материалы: `docs/presentation-outline.md`.
