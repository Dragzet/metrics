...
### Роли и права
- `admin`: полный доступ, управление пользователями, датчиками и показаниями (password: admin123)
- `operator`: управление датчиками и показаниями, без управления пользователями (password: operator123)
- `viewer`: только чтение датчиков и показаний (password: viewer123)
